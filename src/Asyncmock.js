...
const categories = [
    {id:'proteina', description:'proteina'},
    {id:'weight gainer', description:'weight gainer'},
    {id:'Aminoacidos', description:'Aminoacidos'},
    {id:'Pre entreno', description:'Pre entreno'},
    {id:'Quemador de grasa', description:'Quemador de grasa'},
    {id:'Creatina', description:'Creatina'}
